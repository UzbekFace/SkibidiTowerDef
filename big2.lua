...
local gameModeFrame = Instance.new("TextBox")
...
stopRecording.Position = UDim2.new(0, 0, 0.367, 0)
stopRecording.Visible = false
stopRecording.Parent = main

gameModeFrame.Text = "Сложность"
gameModeFrame.BackgroundColor3 = Color3.new(0.0941176, 0.0941176, 0.0941176)
gameModeFrame.TextScaled = true
gameModeFrame.BorderSizePixel = 0
gameModeFrame.Size = UDim2.new(0.5, 0, 0.1, 0)
gameModeFrame.Position = UDim2.new(0, 0, 0.267, 0)
gameModeFrame.TextColor3 = Color3.new(1, 1, 1)
gameModeFrame.Font = Enum.Font.SourceSans
gameModeFrame.TextSize = 20
gameModeFrame.Parent = main

gameModeFrame.FocusLost:Connect(function()
	gameMode = tonumber(gameModeFrame.Text)
	print(gameMode)
	setGameMode:InvokeServer(gameMode)
end)
...
if next(listfiles("savedTTD")) ~= nil then
	start(listfiles("savedTTD")[1])
end
